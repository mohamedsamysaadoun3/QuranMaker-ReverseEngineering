...
public class Template implements Serializable {
    ...
    private final List<FreeElement> freeElementList = new ArrayList();

    public void addFreeElement(FreeElement freeElement) {
        this.freeElementList.add(freeElement);
    }

    public List<FreeElement> getFreeElementList() {
        return this.freeElementList;
    }

    public void removeFreeElement(FreeElement freeElement) {
        this.freeElementList.remove(freeElement);
    }
