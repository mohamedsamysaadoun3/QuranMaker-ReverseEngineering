...
public class ProVersionActivity extends Base implements PurchasesUpdatedListener {
    ...
    public void explode() {
        ...
        konfettiView.start(spread.shapes(m).colors(Arrays.asList(-1216136524, -1124760279, -2019220, -1124760279)).setSpeedBetween(0.0f, 30.0f).position(new Position.Relative(0.5d, 0.3d)).getParty());
    }
