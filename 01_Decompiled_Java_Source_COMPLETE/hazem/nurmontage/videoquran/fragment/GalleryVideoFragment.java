...
public class GalleryVideoFragment extends Fragment {
    ...
    private void loadVideos(View view) {
        ...
        if (file != null) {
            ...
            new Thread(new Runnable() { // from class: hazem.nurmontage.videoquran.fragment.GalleryVideoFragment.1
                ...
                public void run() {
                    ...
                    query.close();
                    GalleryVideoFragment.this.requireActivity().runOnUiThread(new Runnable() { // from class: hazem.nurmontage.videoquran.fragment.GalleryVideoFragment.1.1
                        @Override // java.lang.Runnable
                        public void run() {
