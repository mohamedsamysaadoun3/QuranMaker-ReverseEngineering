...
public class ColorS_NameFragment extends Fragment {
        ...
        for (final int i2 = 0; i2 < 4; i2++) {
            textViewArr[i2].setOnClickListener(new View.OnClickListener() { // from class: hazem.nurmontage.videoquran.fragment.ColorS_NameFragment$$ExternalSyntheticLambda0
                ...
                public final void onClick(View view2) {
                    ColorS_NameFragment.this.m1092x3e82bbb3(textViewArr, i2, ayaTextPresetArr, view2);
                }
            });
        }
    ...
    /* renamed from: lambda$setupPresetButtons$0$hazem-nurmontage-videoquran-fragment-ColorS_NameFragment, reason: not valid java name */
    /* synthetic */ void m1092x3e82bbb3(TextView[] textViewArr, int i, AyaTextPreset[] ayaTextPresetArr, View view) {
        selectPreset(textViewArr, i);
    ...
    public View onCreateView(LayoutInflater layoutInflater, ViewGroup viewGroup, Bundle bundle) {
        ...
        if (this.iEditSName != null && this.entity_select != null && this.resources != null) {
            ...
            root.findViewById(R.id.btn_done).setOnClickListener(new View.OnClickListener() { // from class: hazem.nurmontage.videoquran.fragment.ColorS_NameFragment.1
                @Override // android.view.View.OnClickListener
