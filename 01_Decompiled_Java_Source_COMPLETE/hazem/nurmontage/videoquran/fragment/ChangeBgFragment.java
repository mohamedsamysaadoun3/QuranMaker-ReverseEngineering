...
import hazem.nurmontage.videoquran.PixabaySearchActivity;
...
public class ChangeBgFragment extends Fragment {
    ...
    private void setupButtons(View view) {
        ...
        view.findViewById(R.id.btn_add_pixabay).setOnClickListener(new View.OnClickListener() { // from class: hazem.nurmontage.videoquran.fragment.ChangeBgFragment$$ExternalSyntheticLambdaPixabay
            @Override // android.view.View.OnClickListener
            public final void onClick(View view2) {
                FragmentActivity activity = ChangeBgFragment.this.getActivity();
                if (activity != null) {
                    activity.startActivity(new Intent(activity, (Class<?>) PixabaySearchActivity.class));
                }
            }
        });
