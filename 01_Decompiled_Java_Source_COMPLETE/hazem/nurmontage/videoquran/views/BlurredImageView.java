...
public class BlurredImageView extends View implements View.OnTouchListener {
    ...
    public BlurredImageView(Context context) {
        ...
        this.gestureListener = new GestureDetector.SimpleOnGestureListener() { // from class: hazem.nurmontage.videoquran.views.BlurredImageView.1
            ...
            public void onLongPress(MotionEvent motionEvent) {
                RectF rect;
                if (BlurredImageView.this.entity_select != null && BlurredImageView.this.entity_select.isVisible() && (rect = BlurredImageView.this.entity_select.getRect()) != null && rect.contains(motionEvent.getX(), motionEvent.getY())) {
                    if (BlurredImageView.this.selectTool == null || !BlurredImageView.this.selectTool.isApply_Scale()) {
                        BlurredImageView.this.isDragging = true;
                        if (BlurredImageView.this.selectTool != null) {
                            BlurredImageView.this.selectTool.setApply_Move(true);
                        }
                    }
                }
            }
    ...
    */
    ...
    public boolean onTouch(View view, MotionEvent motionEvent) {
        ...
        float x = (motionEvent.getX() + getPaddingLeft()) - this.mDrawingTranslationX;
        float y = (motionEvent.getY() + getPaddingTop()) - this.mDrawingTranslationY;
        motionEvent.setLocation(x, y);
        if (this.isDragging) {
            int action = motionEvent.getAction() & 255;
            if (action == 2) {
                float f = x - this.dragLastX;
                float f2 = y - this.dragLastY;
                if (this.entity_select != null && this.entity_select.getRect() != null) {
                    this.entity_select.getRect().offset(f, f2);
                    this.entity_select.postTranslate(f, f2);
                }
                this.dragLastX = x;
                this.dragLastY = y;
                invalidate();
            ...
            this.isDragging = false;
            if (this.selectTool != null && this.selectTool.isApply_Move() && this.entity_select != null && this.iViewCallback != null) {
                this.iViewCallback.onEndMove();
            }
            if (this.selectTool != null) {
        ...
        if (entitySelectTool != null && entitySelectTool.isOnProgress() && this.selectTool.isApply_Scale() && this.entity_select != null) {
            if (motionEvent.getAction() == 2 && this.prevDistance > 0.0f) {
                ...
                float f4 = (distanceToCenter - f3) / f3;
                if (f4 > 0.5f) {
                    f4 = 0.5f;
                }
                if (f4 < -0.5f) {
                ...
                this.entity_select.scale(f4 + 1.0f, getmCanvas_width(), getmCanvas_height());
                invalidate();
