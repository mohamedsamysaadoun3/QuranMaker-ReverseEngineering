...
public class ExtendedFloatingActionButton extends MaterialButton implements CoordinatorLayout.AttachedBehavior {
    ...
    static final Property<View, Float> WIDTH = new Property<View, Float>(Float.class, StreamInformation.KEY_WIDTH) { // from class: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.6
    ...
    static final Property<View, Float> HEIGHT = new Property<View, Float>(Float.class, StreamInformation.KEY_HEIGHT) { // from class: com.google.android.material.floatingactionbutton.ExtendedFloatingActionButton.7
        @Override // android.util.Property
        public void set(View view, Float f) {
    ...
    */
    ...
    class ChangeSizeStrategy extends BaseMotionStrategy {
        ...
        public AnimatorSet createAnimator() {
            ...
            if (currentMotionSpec.hasPropertyValues(StreamInformation.KEY_WIDTH)) {
                ...
                currentMotionSpec.setPropertyValues(StreamInformation.KEY_WIDTH, propertyValues);
            }
            if (currentMotionSpec.hasPropertyValues(StreamInformation.KEY_HEIGHT)) {
                ...
                currentMotionSpec.setPropertyValues(StreamInformation.KEY_HEIGHT, propertyValues2);
            }
