...
public abstract class DispatchedTask<T> extends Task {
    ...
    public final void run() {
        Object m1292constructorimpl;
        UndispatchedCoroutine<?> undispatchedCoroutine;
        Object m1292constructorimpl2;
        ...
        try {
            ...
            try {
                ...
                if (job != null && !job.isActive()) {
                    ...
                    if (DebugKt.getRECOVER_STACK_TRACES() && (continuation instanceof CoroutineStackFrame)) {
                        ...
                        continuation.resumeWith(Result.m1292constructorimpl(ResultKt.createFailure(cancellationException)));
                    }
                    cancellationException = cancellationException2;
                    continuation.resumeWith(Result.m1292constructorimpl(ResultKt.createFailure(cancellationException)));
                } else if (exceptionalResult$kotlinx_coroutines_core != null) {
                    Result.Companion companion2 = Result.INSTANCE;
                    continuation.resumeWith(Result.m1292constructorimpl(ResultKt.createFailure(exceptionalResult$kotlinx_coroutines_core)));
                } else {
                    Result.Companion companion3 = Result.INSTANCE;
                    continuation.resumeWith(Result.m1292constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(takeState$kotlinx_coroutines_core)));
                }
                ...
                try {
                    ...
                    m1292constructorimpl2 = Result.m1292constructorimpl(Unit.INSTANCE);
                } catch (Throwable th) {
                    Result.Companion companion5 = Result.INSTANCE;
                    m1292constructorimpl2 = Result.m1292constructorimpl(ResultKt.createFailure(th));
                }
                handleFatalException(null, Result.m1295exceptionOrNullimpl(m1292constructorimpl2));
            } finally {
            ...
            try {
                ...
                taskContext.afterTask();
                m1292constructorimpl = Result.m1292constructorimpl(Unit.INSTANCE);
            } catch (Throwable th3) {
                Result.Companion companion7 = Result.INSTANCE;
                m1292constructorimpl = Result.m1292constructorimpl(ResultKt.createFailure(th3));
            }
            handleFatalException(th2, Result.m1295exceptionOrNullimpl(m1292constructorimpl));
        }
    }
