...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            m1292constructorimpl = Result.m1292constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            m1292constructorimpl = Result.m1292constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m1298isFailureimpl(m1292constructorimpl) ? null : m1292constructorimpl);
        ...
        try {
            Signal.handle(new Signal("TRAP"), new SignalHandler() { // from class: kotlinx.coroutines.debug.AgentPremain$$ExternalSyntheticLambda0
                public final void handle(Signal signal) {
                    AgentPremain.m2823installSignalHandler$lambda1(signal);
                }
            });
    ...
    public static final void m2823installSignalHandler$lambda1(Signal signal) {
