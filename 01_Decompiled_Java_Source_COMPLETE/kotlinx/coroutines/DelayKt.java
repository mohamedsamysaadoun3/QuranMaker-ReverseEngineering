...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo2847scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m2784delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m2785toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m2785toDelayMillisLRDsOJo(long j) {
        if (Duration.m2618compareToLRDsOJo(j, Duration.INSTANCE.m2722getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m2637getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
