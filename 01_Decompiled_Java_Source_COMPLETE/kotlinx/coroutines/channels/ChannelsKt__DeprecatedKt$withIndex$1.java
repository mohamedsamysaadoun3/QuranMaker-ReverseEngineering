...
@DebugMetadata(c = "kotlinx.coroutines.channels.ChannelsKt__DeprecatedKt$withIndex$1", f = "Deprecated.kt", i = {0, 0, 1, 1}, l = {370, 371}, m = "invokeSuspend", n = {"$this$produce", StreamInformation.KEY_INDEX, "$this$produce", StreamInformation.KEY_INDEX}, s = {"L$0", "I$0", "L$0", "I$0"})
