...
public class ChannelCoroutine<E> extends AbstractCoroutine<Unit> implements Channel<E> {
    ...
    public Object mo2798receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation) {
        Object obj = this._channel.mo2798receiveCatchingJP2dKIU(continuation);
    ...
    public Object mo2799tryReceivePtdJZtk() {
        return this._channel.mo2799tryReceivePtdJZtk();
    }

    @Override // kotlinx.coroutines.channels.SendChannel
    /* renamed from: trySend-JP2dKIU */
    public Object mo2800trySendJP2dKIU(E element) {
        return this._channel.mo2800trySendJP2dKIU(element);
    }
