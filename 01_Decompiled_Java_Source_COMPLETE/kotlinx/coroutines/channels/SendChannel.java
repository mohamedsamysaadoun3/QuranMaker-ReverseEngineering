...
public interface SendChannel<E> {
    ...
    Object mo2800trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) {
            Object mo2800trySendJP2dKIU = sendChannel.mo2800trySendJP2dKIU(e);
            if (ChannelResult.m2815isSuccessimpl(mo2800trySendJP2dKIU)) {
                return true;
            }
            Throwable m2809exceptionOrNullimpl = ChannelResult.m2809exceptionOrNullimpl(mo2800trySendJP2dKIU);
