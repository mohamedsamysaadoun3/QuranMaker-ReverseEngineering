...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo2610minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m2756minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: elapsedNow-UwyO8pc */
    public long mo2609elapsedNowUwyO8pc() {
        return Duration.m2654minusLRDsOJo(this.mark.mo2609elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* renamed from: plus-LRDsOJo */
    public TimeMark mo2612plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m2655plusLRDsOJo(this.adjustment, duration), null);
    }
}
