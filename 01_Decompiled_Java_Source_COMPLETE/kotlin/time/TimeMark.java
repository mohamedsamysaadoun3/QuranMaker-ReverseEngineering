...
public interface TimeMark {
    ...
    TimeMark mo2610minusLRDsOJo(long duration);

    /* renamed from: plus-LRDsOJo */
    TimeMark mo2612plusLRDsOJo(long duration);

    /* compiled from: TimeSource.kt */
    @Metadata(k = 3, mv = {1, 9, 0}, xi = 48)
    public static final class DefaultImpls {
        /* renamed from: plus-LRDsOJo, reason: not valid java name */
        public static TimeMark m2757plusLRDsOJo(TimeMark timeMark, long j) {
            return new AdjustedTimeMark(timeMark, j, null);
        }

        /* renamed from: minus-LRDsOJo, reason: not valid java name */
        public static TimeMark m2756minusLRDsOJo(TimeMark timeMark, long j) {
            return timeMark.mo2612plusLRDsOJo(Duration.m2672unaryMinusUwyO8pc(j));
        }

        public static boolean hasPassedNow(TimeMark timeMark) {
            return !Duration.m2652isNegativeimpl(timeMark.mo2609elapsedNowUwyO8pc());
        }
