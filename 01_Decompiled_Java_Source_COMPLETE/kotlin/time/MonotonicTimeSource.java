...
public final class MonotonicTimeSource implements TimeSource.WithComparableMarks {
    ...
    public /* bridge */ /* synthetic */ ComparableTimeMark markNow() {
        return TimeSource.Monotonic.ValueTimeMark.m2759boximpl(m2753markNowz9LOYto());
    }
    ...
    public long m2753markNowz9LOYto() {
        return TimeSource.Monotonic.ValueTimeMark.m2762constructorimpl(read());
    }

    /* renamed from: elapsedFrom-6eNON_k, reason: not valid java name */
    public final long m2752elapsedFrom6eNON_k(long timeMark) {
    ...
    public final long m2751differenceBetweenfRLX17w(long one, long another) {
        return LongSaturatedMathKt.saturatingOriginsDiff(one, another, DurationUnit.NANOSECONDS);
    }

    /* renamed from: adjustReading-6QKq23U, reason: not valid java name */
    public final long m2750adjustReading6QKq23U(long timeMark, long duration) {
        return TimeSource.Monotonic.ValueTimeMark.m2762constructorimpl(LongSaturatedMathKt.m2748saturatingAddNuflL3o(timeMark, DurationUnit.NANOSECONDS, duration));
    }
}
