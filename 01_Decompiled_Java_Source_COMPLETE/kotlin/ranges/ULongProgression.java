...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int m1467constructorimpl = ((int) ULong.m1467constructorimpl(j ^ ULong.m1467constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int m1467constructorimpl2 = (m1467constructorimpl + ((int) ULong.m1467constructorimpl(j2 ^ ULong.m1467constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return m1467constructorimpl2 + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            append = new StringBuilder().append((Object) ULong.m1513toStringimpl(this.first)).append("..").append((Object) ULong.m1513toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            append = new StringBuilder().append((Object) ULong.m1513toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m1513toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
