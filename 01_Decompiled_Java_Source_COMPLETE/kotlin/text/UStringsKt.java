...
public final class UStringsKt {
    ...
    public static final String m2606toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m2608toStringolVBNx4(short s, int i) {
    ...
    public static final String m2607toStringV7xB4Y4(int i, int i2) {
        return UnsignedKt.ulongToString(i & 4294967295L, CharsKt.checkRadix(i2));
    }

    /* renamed from: toString-JSWoG40, reason: not valid java name */
    public static final String m2605toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        compare = Integer.compare(data ^ Integer.MIN_VALUE, UInt.m1388constructorimpl(255) ^ Integer.MIN_VALUE);
        if (compare > 0) {
            return null;
        }
        return UByte.m1304boximpl(UByte.m1310constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        compare = Integer.compare(data ^ Integer.MIN_VALUE, UInt.m1388constructorimpl(65535) ^ Integer.MIN_VALUE);
        if (compare > 0) {
            return null;
        }
        return UShort.m1568boximpl(UShort.m1574constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int m1388constructorimpl = UInt.m1388constructorimpl(i);
        int i4 = 119304647;
        while (i2 < length) {
            ...
            if (compare > 0) {
                if (i4 == 119304647) {
                    i4 = UByte$$ExternalSyntheticBackport0.m(-1, m1388constructorimpl);
            ...
            int m1388constructorimpl2 = UInt.m1388constructorimpl(i3 * m1388constructorimpl);
            int m1388constructorimpl3 = UInt.m1388constructorimpl(UInt.m1388constructorimpl(digitOf) + m1388constructorimpl2);
            compare2 = Integer.compare(m1388constructorimpl3 ^ Integer.MIN_VALUE, m1388constructorimpl2 ^ Integer.MIN_VALUE);
            if (compare2 < 0) {
                return null;
            }
            i2++;
            i3 = m1388constructorimpl3;
        }
        return UInt.m1382boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long m1467constructorimpl = ULong.m1467constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (compare > 0) {
                if (j2 == 512409557603043100L) {
                    j2 = UByte$$ExternalSyntheticBackport0.m$1(-1L, m1467constructorimpl);
            ...
            long m1467constructorimpl2 = ULong.m1467constructorimpl(j * m1467constructorimpl);
            long m1467constructorimpl3 = ULong.m1467constructorimpl(ULong.m1467constructorimpl(UInt.m1388constructorimpl(r13) & 4294967295L) + m1467constructorimpl2);
            compare2 = Long.compare(m1467constructorimpl3 ^ Long.MIN_VALUE, m1467constructorimpl2 ^ Long.MIN_VALUE);
            if (compare2 < 0) {
                return null;
            }
            i2++;
            j = m1467constructorimpl3;
        }
        return ULong.m1461boximpl(j);
    }
}
