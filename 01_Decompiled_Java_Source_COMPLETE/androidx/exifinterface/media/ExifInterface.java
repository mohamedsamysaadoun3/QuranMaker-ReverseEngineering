...
public class ExifInterface {
    ...
    */
    ...
    public void setAltitude(double d) {
        String str = d >= 0.0d ? "0" : IcyHeaders.REQUEST_HEADER_ENABLE_METADATA_VALUE;
