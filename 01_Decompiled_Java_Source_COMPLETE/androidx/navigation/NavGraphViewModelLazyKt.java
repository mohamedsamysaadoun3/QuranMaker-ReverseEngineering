...
public final class NavGraphViewModelLazyKt {
    ...
    public static final NavBackStackEntry m283navGraphViewModels$lambda0(Lazy<NavBackStackEntry> lazy) {
    ...
    public static final NavBackStackEntry m284navGraphViewModels$lambda1(Lazy<NavBackStackEntry> lazy) {
        return lazy.getValue();
    }
    ...
    public static final NavBackStackEntry m285navGraphViewModels$lambda2(Lazy<NavBackStackEntry> lazy) {
        return lazy.getValue();
    }
    ...
    public static final NavBackStackEntry m286navGraphViewModels$lambda3(Lazy<NavBackStackEntry> lazy) {
        return lazy.getValue();
    }
}
