...
public final class MediaFormatUtil {
    ...
    public static MediaFormat createMediaFormatFromFormat(Format format) {
        ...
        maybeSetInteger(mediaFormat, StreamInformation.KEY_WIDTH, format.width);
        maybeSetInteger(mediaFormat, StreamInformation.KEY_HEIGHT, format.height);
