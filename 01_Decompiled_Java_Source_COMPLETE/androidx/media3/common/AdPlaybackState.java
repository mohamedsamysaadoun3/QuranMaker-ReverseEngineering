...
public final class AdPlaybackState {
    ...
    public static final class AdGroup {
        ...
        public AdGroup withAdState(int i, int i2) {
            ...
            return new AdGroup(this.timeUs, this.count, this.originalCount, copyStatesWithSpaceForAdCount, mediaItemArr2, jArr2, this.contentResumeOffsetUs, this.isServerSideInserted, strArr, this.isPlaceholder);
        }
