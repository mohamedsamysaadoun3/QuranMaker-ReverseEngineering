...
public final class Mp4Extractor implements Extractor, SeekMap {
    ...
    */
        ...
        while (i2 < parseTraks.size()) {
            ...
            if (trackSampleTable.sampleCount == 0) {
                ...
                if (track.type == 2) {
                    ...
                    if (this.readingAuxiliaryTracks) {
                        i6 |= 32768;
                        buildUpon.setAuxiliaryTrackType(list.get(i2).intValue());
                    }
                    buildUpon.setRoleFlags(i6);
                }
                ...
                metadata4 = metadata6;
                MetadataUtil.setFormatMetadata(i7, metadata4, buildUpon, metadata7, metadataArr);
    ...
    private int readSample(ExtractorInput extractorInput, PositionHolder positionHolder) throws IOException {
        ...
        long j = mp4Track.sampleTable.offsets[i3] + this.sampleOffsetForAuxiliaryTracks;
        ...
        if (j2 < 0) {
            ...
            if (j2 < RELOAD_MINIMUM_SEEK_DISTANCE) {
                ...
                if (mp4Track.track.nalUnitLengthFieldLength != 0) {
                    ...
                    while (this.sampleBytesWritten < i4) {
                        ...
                        if (i6 == 0) {
                            ...
                            if (this.isSampleDependedOn || NalUnitUtil.numberOfBytesInNalUnitHeader(mp4Track.track.format) + i7 > mp4Track.sampleTable.sizes[i3] - this.sampleBytesRead) {
                                i2 = 0;
                            } else {
                ...
                int i10 = mp4Track.sampleTable.flags[i3];
