...
public final class DtsUtil {
    ...
    */
    ...
    public static DtsHeader parseDtsUhdHeader(byte[] bArr, AtomicInteger atomicInteger) throws ParserException {
        ...
        return new DtsHeader(MimeTypes.AUDIO_DTS_X, 2, i5, parseUnsignedVarInt + i6 + (atomicInteger.get() != 0 ? parseUnsignedVarInt(normalizedFrame, UHD_AUDIO_CHUNK_SIZE_LENGTH_TABLE, true) : 0), j2, 0);
    }
