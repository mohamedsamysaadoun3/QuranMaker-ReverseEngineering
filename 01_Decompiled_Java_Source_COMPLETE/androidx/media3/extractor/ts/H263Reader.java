...
public final class H263Reader implements ElementaryStreamReader {
    ...
    H263Reader(UserDataReader userDataReader, String str) {
    ...
    private static Format parseCsdBuffer(CsdBuffer csdBuffer, int i, String str, String str2) {
        ...
        parsableBitArray.skipBit();
        parsableBitArray.skipBit();
        return new Format.Builder().setId(str).setContainerMimeType(str2).setSampleMimeType(MimeTypes.VIDEO_MP4V).setWidth(readBits5).setHeight(readBits6).setPixelWidthHeightRatio(f).setInitializationData(Collections.singletonList(copyOf)).build();
    }
