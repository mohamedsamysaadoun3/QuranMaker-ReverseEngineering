...
public class FileProvider extends ContentProvider {
    ...
    static class SimplePathStrategy implements PathStrategy {
        ...
        private boolean belongsToRoot(String str, String str2) {
            ...
            return removeTrailingSlash.equals(removeTrailingSlash2) || removeTrailingSlash.startsWith(new StringBuilder().append(removeTrailingSlash2).append(IOUtils.DIR_SEPARATOR_UNIX).toString());
        }
    }
